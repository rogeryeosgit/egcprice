  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'EverGrow Coin price today on crypto exchanges. Get EGC token prices updated in real-time (Pancakeswap, BitMart, ZTGlobal, LBank, Bibox, Hotbit, Bitrue, DigiFinex and Coinsbit)' },
